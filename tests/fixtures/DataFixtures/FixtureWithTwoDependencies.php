...
class FixtureWithTwoDependencies extends AbstractContainerAwareFixture implements MongoFixtureInterface, DependentFixtureInterface
{
    ...
    {
        return 'fixtureWithTwoDependenciesCollection';
    }
    ...
    public function getDependencies(): array
    {
        return [
            ...
            FixtureWithOneDependency::class
        ];
    }
}